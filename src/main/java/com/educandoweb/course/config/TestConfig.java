...
import com.educandoweb.course.repositories.OrderItemRpository;
...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private OrderItemRpository orderItemRpository;
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T16:55:07z"),OrderStatus.PAID, u1);
		Order o2 = new Order(null, Instant.parse("2019-06-21T12:53:07z"),OrderStatus.WAITING_PAYMENT, u1);
		Order o3 = new Order(null, Instant.parse("2019-06-22T21:53:07z"),OrderStatus.WAITING_PAYMENT, u3);
